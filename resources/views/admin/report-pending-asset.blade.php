...
@section('content')
    <div class="box box-default" style="border-top: 0px; padding-top: 30px; border-radius: 0px">
        <div class="box-header">
            <h3 class="box-title">PENDING ASSETS TO RECEIVES</h3>
        </div>

        @if(!count($purchase_requisitions))
            <div class="box-body" style="border-radius: 0px"><h4 class="text-warning">Sorry! There is no pending assets.</h4></div>
        @endif
